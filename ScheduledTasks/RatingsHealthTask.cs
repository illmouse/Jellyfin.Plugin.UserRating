...
{
    public class RatingsHealthTask : IScheduledTask
    {
        private readonly HealthCheckService _healthCheckService;
        private readonly ILogger<RatingsHealthTask> _logger;

        public RatingsHealthTask(
            HealthCheckService healthCheckService,
            ILogger<RatingsHealthTask> logger)
        {
        ...
        {
            _logger.LogInformation("Starting scheduled ratings database health check");
            ...
            {
                _logger.LogError(ex, "Error during scheduled ratings health check");
                progress.Report(100);
            }
